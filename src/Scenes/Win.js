class Win extends Phaser.Scene {
    ...
    create() {
        ...
        let TitleText = this.add.text(400, 200, "You Win!", {
            fontFamily: "Arial",
            fontSize: "64px",
            color: "#000000",
            align: "center",
        ...
        let KeyText = this.add.text(400, 275, "Press Any Key to Restart", {
            fontFamily: "Arial",
            fontSize: "26px",
            color: "#000000",
            align: "center",
    ...
    update() {
        ...
        this.player.angle += 1; // rotate the player sprite by 1 degree every frame
    }
